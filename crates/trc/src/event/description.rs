...
impl ServerEvent {
    pub fn description(&self) -> &'static str {
        match self {
            ServerEvent::Startup => {
                concat!("Starting A3Mailer Server v", env!("CARGO_PKG_VERSION"))
            }
            ServerEvent::Shutdown => {
                concat!("Shutting down A3Mailer Server v", env!("CARGO_PKG_VERSION"))
            }
    ...
    pub fn explain(&self) -> &'static str {
        match self {
            ServerEvent::Startup => "A3Mailer Server has started",
            ServerEvent::Shutdown => "A3Mailer Server is shutting down",
